...
if __name__ == '__main__':
    ...
    # parser.add_argument('--w_hpf', type=float, default=0)
    # parser.add_argument('--result_dir', type=str, default='/opt/deeplearning/tai/StarGanV2/Models/002_w2a/results')
    # parser.add_argument('--src_dir', type=str, default='/opt/deeplearning/tai/StarGanV2/Models/002_w2a/representative/src')
    # parser.add_argument('--ref_dir', type=str, default='/opt/deeplearning/tai/StarGanV2/Models/002_w2a/representative/ref')
    ...
    parser.add_argument('--lambda_ds', type=float, default=1)
    parser.add_argument('--train_img_dir', type=str, default='data/resume/train')
    parser.add_argument('--val_img_dir', type=str, default='data/resume/val')
    parser.add_argument('--sample_dir', type=str, default='expr/samples')
    parser.add_argument('--checkpoint_dir', type=str, default='expr/checkpoints')
    parser.add_argument('--eval_dir', type=str, default='expr/eval')
    parser.add_argument('--batch_size', type=int, default=8)
